...
export class C___getConfigurationResultValue0Struct extends ethereum.Tuple {
  get data(): BigInt {
    return this[0].toBigInt();
  }
}

export class C___getReserveDataResultValue0Struct extends ethereum.Tuple {
  get configuration(): C___getReserveDataResultValue0ConfigurationStruct {
    return this[0].toTuple() as C___getReserveDataResultValue0ConfigurationStruct;
  }
...
export class C___getReserveDataResultValue0ConfigurationStruct extends ethereum.Tuple {
  get data(): BigInt {
    return this[0].toBigInt();
  }
}

export class C___getUserAccountDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class C___getUserConfigurationResultValue0Struct extends ethereum.Tuple {
  get data(): BigInt {
    return this[0].toBigInt();
  }
}

export class C_ extends ethereum.SmartContract {
  static bind(address: Address): C_ {
    return new C_("C_", address);
  }
  ...
  getConfiguration(asset: Address): C___getConfigurationResultValue0Struct {
    let result = super.call(
      "getConfiguration",
    ...
    return result[0].toTuple() as C___getConfigurationResultValue0Struct;
  }

  try_getConfiguration(
    asset: Address
  ): ethereum.CallResult<C___getConfigurationResultValue0Struct> {
    let result = super.tryCall(
      "getConfiguration",
      "getConfiguration(address):((uint256))",
      [ethereum.Value.fromAddress(asset)]
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as C___getConfigurationResultValue0Struct
    );
  }

  getReserveData(asset: Address): C___getReserveDataResultValue0Struct {
    let result = super.call(
      "getReserveData",
    ...
    return result[0].toTuple() as C___getReserveDataResultValue0Struct;
  }

  try_getReserveData(
    asset: Address
  ): ethereum.CallResult<C___getReserveDataResultValue0Struct> {
    let result = super.tryCall(
      "getReserveData",
      "getReserveData(address):(((uint256),uint128,uint128,uint128,uint128,uint128,uint40,address,address,address,address,uint8))",
      [ethereum.Value.fromAddress(asset)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as C___getReserveDataResultValue0Struct
    );
  }
  ...
  getUserAccountData(user: Address): C___getUserAccountDataResult {
    let result = super.call(
      "getUserAccountData",
    ...
    return new C___getUserAccountDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getUserAccountData(
    user: Address
  ): ethereum.CallResult<C___getUserAccountDataResult> {
    let result = super.tryCall(
      "getUserAccountData",
      "getUserAccountData(address):(uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(user)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new C___getUserAccountDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getUserConfiguration(
    user: Address
  ): C___getUserConfigurationResultValue0Struct {
    let result = super.call(
      "getUserConfiguration",
    ...
    return result[0].toTuple() as C___getUserConfigurationResultValue0Struct;
  }

  try_getUserConfiguration(
    user: Address
  ): ethereum.CallResult<C___getUserConfigurationResultValue0Struct> {
    let result = super.tryCall(
      "getUserConfiguration",
      "getUserConfiguration(address):((uint256))",
      [ethereum.Value.fromAddress(user)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as C___getUserConfigurationResultValue0Struct
    );
  }
